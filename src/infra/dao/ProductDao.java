...
public class ProductDao {
    ...
    private static void initDefaults() {
        ...
        personal.setStatus(ProductStatus.ON_SALE);
        ...
        business.setStatus(ProductStatus.ON_SALE);
        ...
        commercial.setStatus(ProductStatus.DISCONTINUED);
        ...
        design.setStatus(ProductStatus.DESIGN_COMPLETE);
    ...
    public List<Product> findAll() { return Collections.unmodifiableList(STORE); }

    public Product findById(String productId) {
        return STORE.stream().filter(p -> p.getProductId().equals(productId)).findFirst().orElse(null);
    }
