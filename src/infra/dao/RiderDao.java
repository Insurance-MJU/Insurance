...
public class RiderDao {
    ...
    public Rider findByCode(String riderCode) { return STORE.get(riderCode); }
    public List<Rider> findAll() { return Collections.unmodifiableList(new ArrayList<>(STORE.values())); }
}
