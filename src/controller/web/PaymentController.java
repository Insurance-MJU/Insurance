...
public class PaymentController {
    ...
    private record PaymentOrder(String contractId, long amount) {}

    public PaymentController(ContractList contractList, TossConfig tossConfig) {
    ...
    public void registerRoutes(Router router) {
        router.post("/payments/prepare", (req, res) -> {
            ...
            pendingOrders.put(orderId, new PaymentOrder(contract.getContractId(), body.amount()));
