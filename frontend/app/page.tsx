    ...
    return (
        <main className="min-h-[100dvh] flex flex-col font-sans">
                ...
                <div className="max-w-6xl mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                        {[
                            ...
                            <div key={i} className="text-center p-8 rounded-3xl bg-slate-50 hover:bg-blue-50 transition-colors border border-transparent hover:border-blue-100">
            ...
            <footer className="mt-auto bg-slate-900 text-slate-400 py-8 text-center text-sm">
                <p>© 2026 한국생명보험. All rights reserved.</p>
                <div className="mt-2 flex justify-center gap-4">
                    <Link href="/auth/login" className="hover:text-white transition">로그인</Link>
                    <span>|</span>
                    <Link href="/employee/dashboard" className="hover:text-white transition">직원 포털</Link>
                </div>
            </footer>
        </main>
    );
